...
gtadb.Map3DFlat = function(options) {

    if (!(this instanceof gtadb.Map3DFlat)) {
        return new gtadb.Map3DFlat(options);
    }
    ...
    let self = {
        ...
        tileSetRanges: {
            ...
            "yanis,15": {0: [[0, 0], [2, 2]], 1: [[0, 1], [4, 5]], 2: [[0, 2], [9, 11]], 3: [[0, 4], [19, 23]], 4: [[0, 8], [38, 47]], 5: [[0, 17], [77, 95]], 6: [[0, 34], [155, 190]]},
            "yanis,16":  { 0: [[0, 0], [2, 3]], 1: [[1, 1], [4, 6]], 2: [[2, 3], [9, 12]], 3: [[5, 6], [19, 24]], 4: [[11, 13], [39, 48]], 5: [[22, 26], [79, 97]], 6: [[44, 52], [158, 194]]}
        },
        defaults: {
    ...
    function updateBackgroundColor() {
        self.backgroundColor = self.backgroundColors[self.tileSet] || self.backgroundColors["yanis,15"];
