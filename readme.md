...
You are welcome to use the [landmark data](https://github.com/rolux/gtadb.org/tree/main/map/data), [photos](https://github.com/rolux/gtadb.org/tree/main/map/photos) or [map tiles](https://github.com/rolux/gtadb.org/tree/main/maps/tiles) for your own purposes. Please do not fetch live data or media from gtadb.org – simply `git pull` for updates. Alternatively, `git sparse-checkout set map/data/6 map/photos/6 maps/tiles/6`
