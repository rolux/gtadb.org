...
You're welcome to use the [landmark data](https://map.gtadb.org/data/6/landmarks.json) or [map tiles](https://github.com/rolux/gtadb.org/tree/main/maps/tiles) for your own purposes.
